...
public class COVID19 {
    ...
    public COVID19(int numPeople, int numMoving, double moveDist, 
                    ...
                    int frameInterval, double drawSize) {
        this.frameInterval = frameInterval;
        this.drawSize = drawSize;
        this.numMoving = numMoving;
        this.numHours = numHours;
        initializePandemic(numPeople, numMoving);
     ...
     */
    private void initializePandemic(int numPeople, int numMoving) {
